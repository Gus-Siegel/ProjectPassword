...
class LoginPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        success_test = tk.Button(self, width=10,
                                text="Success Page",
                                font=("Nunito", 16),
                                bg="#000000",
                                fg="#1F1F1F",
                                command=lambda: controller.
                                show_frame(SuccessPage))
        success_test.pack(pady=0)
        
        failure_test = tk.Button(self, width=10,
                                text="Failure Page",
                                font=("Nunito", 16),
                                bg="#000000",
                                fg="#1F1F1F",
                                command=lambda: controller.
                                show_frame(FailurePage))
        failure_test.pack(pady=20)
